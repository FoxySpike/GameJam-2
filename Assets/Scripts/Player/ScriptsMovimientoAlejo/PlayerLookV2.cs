...
public class PlayerLookV2 : MonoBehaviour
{
    ...
    private void Look()
    {
        ...
        // 1. Acumular la rotaci�n del rat�n
        ...
        // 2. Comprobar si el jugador est� en reposo
        ...
        // Reset individual cuando cada �ngulo completa su propio ciclo de 2*PI
        if (swayTimerX > Mathf.PI * 2f) swayTimerX -= Mathf.PI * 2f;
        if (swayTimerY > Mathf.PI * 2f) swayTimerY -= Mathf.PI * 2f;

        // 5. Calcular oscilaci�n suave sin brincos
