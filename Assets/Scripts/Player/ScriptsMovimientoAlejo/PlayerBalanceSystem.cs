...
public class PlayerBalanceSystem : MonoBehaviour
{
    ...
    private struct PerfilEquilibrio
    {
        ...
        public float instabilityFactor;  // Aceleraci�n de la gravedad en los bordes
    ...
    [Header("Perfiles de P�rdida de Equilibrio")]
    [SerializeField]
    ...
    [Header("Configuraci�n del Control y Sensibilidad")]
    [SerializeField, Tooltip("Poder de correcci�n base del jugador")]
    ...
    [Header("Mec�nica de Tiempo de Gracia / Salvada")]
    [SerializeField, Range(0.5f, 0.9f), Tooltip("A partir de qu� punto del slider se activa la ayuda de emergencia")]
    ...
    private void CalculateBalance()
    {
        ...
        // Transici�n m�s r�pida del ruido para mantener al jugador en alerta constante
        smoothedSwayForce = Mathf.Lerp(smoothedSwayForce, normalizedNoise * currentSwayForce, Time.deltaTime * 8.0f);

        // 2. Detecci�n de Estado y Ayuda en Zona de Peligro
        ...
        // 3. Gravedad H�brida (Combinaci�n Lineal + Cuadr�tica para romper la inercia del centro)
        // (0.3 * x) asegura desequilibrio inmediato; (0.7 * x^2) aporta la aceleraci�n peligrosa en bordes.
        ...
        // 4. Tendencia Natural al Centro (Se reduce a medida que aumenta la inclinaci�n)
