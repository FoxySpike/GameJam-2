...
public partial class @NIS: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Grill"",
            ""id"": ""eb8347fe-976d-4965-b916-5415b73cce08"",
            ""actions"": [
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""1a521f64-63df-4b66-b592-6fc43c1aaf2f"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""HeatControl"",
                    ""type"": ""Value"",
                    ""id"": ""0cddf599-58bb-41a1-a272-cda11df8ef03"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Exit"",
                    ""type"": ""Button"",
                    ""id"": ""17ee1a7f-7683-4f8d-bef2-2e5a7bba1453"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4a7ea28a-7623-4603-b41c-a50c24cdf22b"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""19d7f76a-3cdd-471a-abd6-0824520c285c"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""c000227c-a57f-4aff-84a3-0718999d6198"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""ccc78d4e-eb65-4257-83fb-55cc4beccfe6"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""237205a5-f5e9-4fba-8b88-cb1f63b6b56d"",
                    ""path"": ""<Keyboard>/f"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@NIS()
    {
        ...
        UnityEngine.Debug.Assert(!m_Grill.enabled, "This will cause a leak and performance issues, NIS.Grill.Disable() has not been called.");
    }
    ...
    // Grill
    private readonly InputActionMap m_Grill;
    private List<IGrillActions> m_GrillActionsCallbackInterfaces = new List<IGrillActions>();
    ...
    public struct GrillActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public GrillActions(@NIS wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Grill/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_Grill_Look;
        /// <summary>
        /// Provides access to the underlying input action "Grill/HeatControl".
        /// </summary>
        public InputAction @HeatControl => m_Wrapper.m_Grill_HeatControl;
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Grill; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="GrillActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(GrillActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="GrillActions" />
        public void AddCallbacks(IGrillActions instance)
        {
            if (instance == null || m_Wrapper.m_GrillActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_GrillActionsCallbackInterfaces.Add(instance);
            @Look.started += instance.OnLook;
            @Look.performed += instance.OnLook;
            @Look.canceled += instance.OnLook;
            @HeatControl.started += instance.OnHeatControl;
            @HeatControl.performed += instance.OnHeatControl;
            @HeatControl.canceled += instance.OnHeatControl;
            @Exit.started += instance.OnExit;
            @Exit.performed += instance.OnExit;
            @Exit.canceled += instance.OnExit;
        }
        ...
        /// </remarks>
        /// <seealso cref="GrillActions" />
        private void UnregisterCallbacks(IGrillActions instance)
        {
            @Look.started -= instance.OnLook;
            @Look.performed -= instance.OnLook;
            @Look.canceled -= instance.OnLook;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="GrillActions.UnregisterCallbacks(IGrillActions)" />.
        /// </summary>
        /// <seealso cref="GrillActions.UnregisterCallbacks(IGrillActions)" />
        public void RemoveCallbacks(IGrillActions instance)
        {
            if (m_Wrapper.m_GrillActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="GrillActions.AddCallbacks(IGrillActions)" />
        /// <seealso cref="GrillActions.RemoveCallbacks(IGrillActions)" />
        /// <seealso cref="GrillActions.UnregisterCallbacks(IGrillActions)" />
        public void SetCallbacks(IGrillActions instance)
        {
            foreach (var item in m_Wrapper.m_GrillActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_GrillActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="GrillActions" /> instance referencing this action map.
    /// </summary>
    public GrillActions @Grill => new GrillActions(this);
    /// <summary>
    ...
    /// <seealso cref="GrillActions.AddCallbacks(IGrillActions)" />
    /// <seealso cref="GrillActions.RemoveCallbacks(IGrillActions)" />
    public interface IGrillActions
    {
        /// <summary>
        /// Method invoked when associated input action "Look" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        ...
        void OnLook(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "HeatControl" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnHeatControl(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "Exit" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
